...
export class ContactForm extends FormGroup {
  constructor() {
    super({
      [ContactFormFields.GENDER]: new FormControl('', { nonNullable: true }),
      [ContactFormFields.FIRST_NAME]: new FormControl('', { nonNullable: true }),
      [ContactFormFields.LAST_NAME]: new FormControl('', { nonNullable: true }),
      [ContactFormFields.MAIDEN_NAME]: new FormControl('', { nonNullable: true }),
      [ContactFormFields.ADDRESS]: new FormControl('', { nonNullable: true }),
      [ContactFormFields.PHONE]: new FormControl('', { nonNullable: true }),
      [ContactFormFields.EMAIL]: new FormControl('', { nonNullable: true })
    });
...
export class SituationForm extends FormGroup {
  constructor() {
    super({
      [SituationFormFields.CONTRACT_TYPE]: new FormControl('', { nonNullable: true }),
      [SituationFormFields.INCOME]: new FormControl<number | null>(null),
      [SituationFormFields.HOUSING_STATUS]: new FormControl('', { nonNullable: true }),
      [SituationFormFields.MARITAL_STATUS]: new FormControl('', { nonNullable: true })
    });
  }
}`);
